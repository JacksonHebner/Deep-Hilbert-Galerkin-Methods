...
model.load_state_dict(torch.load("No control, sigma = 1sqrt(2pi), 25 func, 250 hilbert, 600 neur one layer, WN stat.pt2", weights_only=True, map_location=torch.device('cpu')))
model.eval()
