...
torch.save(qnet.state_dict(), "Critic, trained control, sigma = 1sqrt(2pi), 25 func, 250 hilbert, 600 neur one layer, WN stat, QPDE.pt2")
torch.save(control_net.state_dict(), "Actor, trained control, sigma = 1sqrt(2pi), 25 func, 250 hilbert, 600 neur one layer, WN stat, QPDE.pt2")
