...
torch.save(qnet.state_dict(), "Critic, trained control, sigma = trace class, 25 func, 250 hilbert, 600 neur one layer, A2.pt2")
torch.save(control_net.state_dict(), "Actor, trained control, sigma = trace class, 25 func, 250 hilbert, 600 neur one layer, A2.pt2")
