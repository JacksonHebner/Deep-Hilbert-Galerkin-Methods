...
torch.save(qnet.state_dict(), "Critic, trained control, no noise, 25 func, 250 hilbert, 600 neur one layer, WN stat.pt2")
torch.save(control_net.state_dict(), "Actor, trained control, no noise, 25 func, 250 hilbert, 600 neur one layer, WN stat.pt2")
