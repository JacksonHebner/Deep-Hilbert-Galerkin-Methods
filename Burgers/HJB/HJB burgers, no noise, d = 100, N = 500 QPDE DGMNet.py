...
def pde_op_combined(qnet, control_net, input_point):
    ...
    return -(-gamma*val + in_prod + deriv_mag + u_mag + drift).detach() * val
...
torch.save(qnet.state_dict(), "Critic, sigma = 0, HJB, 100 func, 500 hilbert, DGMNet, TCC tail, QPDE.pt2")
torch.save(control_net.state_dict(), "Actor, sigma = 0, HJB, 100 func, 500 hilbert, DGMNet, TCC tail, QPDE.pt2")